<!-- Modal -->
<div>
    <div wire:ignore.self class="modal fade" id="adminProductModal" tabindex="-1" aria-labelledby="adminProductModalLabel"
        aria-hidden="true">
...
<div wire:ignore.self class="modal fade" id="updateAdminProductModal" tabindex="-1"
    aria-labelledby="updateAdminProductModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
...
<div wire:ignore.self class="modal fade" id="deleteAdminProductModal" tabindex="-1"
    aria-labelledby="deleteAdminProductModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
